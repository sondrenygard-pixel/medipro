  ...
  return (
    <header className="subHeader">
      ...
      <nav className="subNav">
        ...
        <a href="/virksomimport Header from "../components/Header"
import Footer from "../components/Footer"

export const metadata = {
  title: "Faglige kilder | MediPro",
  description:
    "MediPro bygger på anerkjente norske og internasjonale kilder for å gi helsepersonell relevant og oppdatert faglig støtte.",
}
      ...
      <section className="subContent">
        ...
        <div className="subGrid">
          <article className="subCard">
            ...
            <p>
              Innhold bygger på anbefalinger fra Helsedirektoratet,
        ...
        <div className="businessCta">
          <div>
            ...
            <h2>
              Et støtteverktøy – ikke en erstatning for faglig vurdering.
            </h2>
